...
public class PrismaMoldActivity extends MainActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener{
    ...
    Calendar refCalendar,tempCalendar,finalCalendar,fabCalendar,assentCalendar;
    PrismaLotes newLote;
    ArrayList<String> dimen;
    public int whatDate=0;
    private ProgressDialog progressDialog;
    long date, fabDate,assentDate;
    ...
    public void initiateViews(){
        ...
        spinner_dimenssion=(Spinner) findViewById(R.id.tipo_spinner);
